...
public Ville(int code, String alpha2, String alpha3, String nom_fr_fr, String nom_en_gb, Pays pays) {
	super();
	this.code = code;
	this.alpha2 = alpha2;
	this.alpha3 = alpha3;
...
public String toString() {
	return "Ville [code=" + code + ", alpha2=" + alpha2 + ", alpha3=" + alpha3 + ", nom_fr_fr=" + nom_fr_fr
			+ ", nom_en_gb=" + nom_en_gb + ", pays=" + pays + "]";
}
